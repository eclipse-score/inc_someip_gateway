...
.. list-table::
   ...
   * - OA Spec Reference (Ch. 6)
     ...
     - Requirement
     - Test Function(s)
   * - Section 6.1.5.6, SOMEIPSRV_ONWIRE_05
     - TC8-MSG-001
     - ``msg_resp_header``
     - ``test_someip_message_format::test_tc8_msg_001_protocol_version``
   * - Section 6.1.5.6, SOMEIPSRV_ONWIRE_07
     - TC8-MSG-002
     - ``msg_resp_header``
...
.. list-table::
   ...
   * - OA Spec Reference (Ch. 6)
     ...
     - Requirement
     - Test Function(s)
   * - Section 6.1.5.5, SOMEIPSRV_BASIC_03; Section 6.1.6, SOMEIP_ETS_147
     - TC8-EVT-001
     - ``evt_subscription``
...
.. list-table::
   ...
   * - Section 6.1.5.7, SOMEIPSRV_RPC_03; Section 6.1.6, SOMEIP_ETS_166
     - TC8-FLD-003
     - ``fld_get_set``
     - ``test_field_conformance::test_tc8_fld_003_getter_returns_current_value``
   * - Section 6.1.5.7, SOMEIPSRV_RPC_11; Section 6.1.6, SOMEIP_ETS_166
     - TC8-FLD-004
     - ``fld_get_set``
...
.. list-table::
   ...
   * - OA Spec Reference (Ch. 6)
     ...
     - Requirement
     - Test Function(s)
   * - Section 6.1.5.7, SOMEIPSRV_RPC_01
     - TC8-TCP-001
     - ``tcp_transport``
...
.. list-table::
   ...
   * - Section 6.1.6, SOMEIP_ETS_178
     - TC8-SDROBUST-027
     - ``sd_robustness``
     - ``test_sd_robustness::TestSDMessageFramingErrors::test_ets_178_wrong_someip_service_id``
   * - Section 6.1.6, SOMEIP_ETS_058
     - TC8-SDROBUST-028
     - ``sd_robustness``
     - NOT IMPLEMENTED
   * - Section 6.1.6, SOMEIP_ETS_113
     - TC8-SDROBUST-029
     - ``sd_robustness``
     - NOT IMPLEMENTED
   * - Section 6.1.6, SOMEIP_ETS_124
     - TC8-SDROBUST-030
     - ``sd_robustness``
     - NOT IMPLEMENTED
   * - Section 6.1.6, SOMEIP_ETS_154
     - TC8-SDROBUST-031
     - ``sd_robustness``
     - NOT IMPLEMENTED
   * - Section 6.1.6, SOMEIP_ETS_162
     - TC8-SDROBUST-032
     - ``sd_robustness``
     - NOT IMPLEMENTED
   * - Section 6.1.6, SOMEIP_ETS_163
     - TC8-SDROBUST-033
     - ``sd_robustness``
     - NOT IMPLEMENTED
   * - Section 6.1.6, SOMEIP_ETS_175
     - TC8-SDROBUST-034
     - ``sd_robustness``
     - NOT IMPLEMENTED
   * - Section 6.1.6, SOMEIP_ETS_176
     - TC8-SDROBUST-035
     - ``sd_robustness``
     - NOT IMPLEMENTED
   * - Section 6.1.6, SOMEIP_ETS_177
     - TC8-SDROBUST-036
     - ``sd_robustness``
     - NOT IMPLEMENTED
...
.. list-table::
   ...
   * - Section 6.1.5.7, SOMEIPSRV_RPC_19
     - TC8-MSG-032
     - ``msg_resp_header``
...
For the full OA TC8 v3.0 Chapter 6 scope analysis (including blocked tests
...
This section maps the 230 test cases in Chapter 6 of the
`OPEN Alliance TC8 ECU Test Specification Layer 3-7
...
For the full test case catalog, see the OA TC8 ECU Test Specification v3.0
(Final), May 2020, Chapter 6.
...
- **Enhanced Testability Service Tests** (``SOMEIP_ETS_*``, 137 items,
  Section 6.1.6) - behavior tests that range from wire-level SD tests
