...
# This script is copied from communication. Do not alter this too much to make syncs easier.
# shellcheck disable=SC2086,SC2312,SC2154
...
if bazel test --config=lsan //:lsan_fail_leak; then
  exit 1;
fi
