...
public:
    MOCK_METHOD(Client_connector::Result<None>, subscribe_event,
                (Event_id client_id, Event_mode mode), (const, noexcept, override));
    MOCK_METHOD(Client_connector::Result<None>, unsubscribe_event, (Event_id),
                (const, noexcept, override));
    MOCK_METHOD(Client_connector::Result<None>, request_event_update, (Event_id),
                (const, noexcept, override));
