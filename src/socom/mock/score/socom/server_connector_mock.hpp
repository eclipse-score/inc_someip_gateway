...
class Server_connector_mock : public Disabled_server_connector, public Enabled_server_connector {
   public:
    ...
    MOCK_METHOD(Enabled_server_connector::Result<Blank>, update_event, (Event_id, Payload::Sptr),
                (noexcept, override));
    MOCK_METHOD(Enabled_server_connector::Result<Blank>, update_requested_event,
                (Event_id, Payload::Sptr), (noexcept, override));
    MOCK_METHOD(Enabled_server_connector::Result<Blank>, set_event_subscription_state,
