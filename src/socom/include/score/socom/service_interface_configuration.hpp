...
public:
    ...
    Server_service_interface_configuration&
    operator=(Server_service_interface_configuration const&) = delete;
    Server_service_interface_configuration&
    operator=(Server_service_interface_configuration&&) = delete;
