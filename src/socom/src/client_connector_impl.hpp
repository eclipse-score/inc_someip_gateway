...
public:
    ...
    message::Unsubscribe_event::Return_type
    unsubscribe_event(Event_id client_id) const noexcept override;
    message::Request_event_update::Return_type
    request_event_update(Event_id client_id) const noexcept override;
    ...
    message::Ack_subscribed_event::Return_type receive(message::Ack_subscribed_event message);
